...
class M2RNN(nn.Module):
    ...
    def forward(
        ...
        # pack only after the convolution: it needs the (B, S) layout to zero out padding,
        # while the recurrence below consumes packed sequences (same order as gated_deltanet)
